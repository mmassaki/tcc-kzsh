...
\textbf{TrafficPolyline:} Classe objeto que possui uma lista de pontos para desenho da malha de transito no mapa. Para cada \emph{TrafficPolyline} é definido uma cor para sua linha, representando as condições do tráfego na região marcada.
