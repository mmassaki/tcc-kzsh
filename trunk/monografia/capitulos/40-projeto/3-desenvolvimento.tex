...
Essa funcionalidade de navegação para a criação de rotas foi estruturada por várias View Controllers necessárias para o fluxo de interatividade com o usuário, que entra com os dados da via de destino e origem no aparelho a fim de gerar uma rota evitando os congestionamentos conhecidos pelo servidor.
...
\textbf{MFMailComposeViewControlle:} Classe auxiliar para o envio via e-mail. O corpo do e-mail é pré-formatado com o endereço do local entrado pelo usuário. Realiza a funcionalidade do software de envio dos e-mails.
